package com.dulgi.practice.java.customClassLoader;

import com.dulgi.practice.java.callBack.BasicCallBackTest;
...
public class CustomClassloaderEx extends ClassLoader{
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        //
        System.out.println("try to load class with custom classloader");
        myClassLoader.loadClass("com.dulgi.practice.java.callBack.BasicCallBackTest");
